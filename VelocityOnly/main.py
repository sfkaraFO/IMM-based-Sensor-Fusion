...
yD, yT1, yT2, trueV = GenerateData(CVModel)

### Sensor Fusion algorithms ###
xK, covK = fuse.KalmanFusion(yD, yT1, yT2, CVModel)
xI, covI, mus = fuse.IMMFusion(yD, yT1, yT2, CVModel)
# txt.GenerateFile(yD, yT1, yT2)
# xN = fuse.NormalFusion(yD, yT1, yT2, CVModel)



print ("Last Covariance: \n", covK[-1,:,:])
print ("REES: \n", REES(trueV, xK, covK))
print ("RMSE: \n", RMSE(trueV, xK))
